...
namespace HR.Entities
{
    ...
    public partial class Performance_RecordsEntity
    {
        [Key] [Required] [Column("id")] public long id { set; get; }

        [Required] [Column("EmpId")] public int EmpId { set; get; }

        [Column("ObjectiveId")] public long? ObjectiveId { set; get; }

        [Required] [Column("IsObjective")] public bool IsObjective { set; get; }

        [Column("CompetencyId")] public long? CompetencyId { set; get; }
