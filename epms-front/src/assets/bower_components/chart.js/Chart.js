...
(function(){
	...
	Chart.defaults = {
		global: {
			...
			scaleFontFamily: "'Helvetica Neue', 'Helvetica', ''Tajawal', sans-serif;', sans-serif",
			...
			tooltipFontFamily: "'Helvetica Neue', 'Helvetica', ''Tajawal', sans-serif;', sans-serif",
			...
			tooltipTitleFontFamily: "'Helvetica Neue', 'Helvetica', ''Tajawal', sans-serif;', sans-serif",
...
(function(){
	...
	Chart.Type.extend({
		...
		defaults:{
			...
			pointLabelFontFamily : "''Tajawal', sans-serif;'",
